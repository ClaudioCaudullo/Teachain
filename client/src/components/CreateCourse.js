...
const CreateCourse = () => {
  ...
  const uploadCourse = async () => {
    ...
    await (
      await contractCourses.addCourse(hash).catch((err) => {
  ...
  return (
    <>
      {isConnected ? (
              ...
              <div className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  <div className={styles.cardTags}>
                    <span className={`${styles.tag} ${tagPrimary}`}>
                      {subject}
                    </span>
                    {secondary ? (
                      <span className={`${styles.tag} ${tagSecondary}`}>
                        {secondary}
                      </span>
                    ) : (
                      <></>
                  ...
                  <h4>{title}</h4>
                  <p className="testo">{description}</p>
        ...
        <>
          <p className="testo">Devi loggarti per visualizzare questa pagina!</p>
        </>
      )}
    </>
  );
