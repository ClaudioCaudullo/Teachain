...
const ZoomCourse = () => {
  let { currentAccount, contractCourses, loadCourses } =
    ...
    if (currentAccount) {
      const fetchData = async () => {
        ...
        let response = await fetch(
          `https://learningdata.infura-ipfs.io/ipfs/${params.id}`
        );
  ...
  async function courseModify() {
    ...
    await (
      await contractCourses.modifyCourse(params.id, hash).catch((err) => {
  ...
  async function waitingMetamask(provider, hash) {
    ...
    await provider
      ...
      .then(async () => {
        await (
          await contractCourses
            .addPurchase(idCourse, currentAccount, "" + hash.hash)
            .catch((error) => {
              setAlertText(error.message);
              setOpen(true);
              setSeverity("error");
  ...
  async function deleteCourse() {
    ...
    await (
      await contractCourses.deleteCourse(x).catch((err) => {
        setAlertText(err.code);
        setOpen(true);
        setSeverity("error");
        setLoading("false");
  ...
  return (
    <div>
      {loading == "true" ? <Loader chiamante="corso" /> : <></>}
      {open == true && severity ? (
        <>
        ...
        <div className={styles.container}>
          <div className={styles.main}>
            ...
            <div className={styles.buttons}>
              <button
                className={styles.btnSpectator}
                onClick={() => setModify(false)}
              >
                Torna alla modalità spettatore
              </button>
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button
                          type="button"
                          className={`btn ${styles.btnConfirmModify}`}
                          data-bs-dismiss="modal"
                          onClick={() => courseModify()}
                        >
                          Conferma
                        </button>
                      </div>
                  ...
                  <div className="modal-dialog">
                    <div className="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <button
                          type="button"
                          className={`btn ${styles.btnConfirmDelete}`}
                          data-bs-dismiss="modal"
          ...
          <div className={styles.container}>
            ...
            <div className={styles.main}>
                  ...
                  >
                    <ul class="list-group list-group-flush">
                      <li
                        ...
                        onClick={() => {
                          navigate(`/profilo/${creator}`);
                        }}
                      >
                        Un corso di: {username}
                      </li>
                ...
                <div class="col-sm-5 offset-md-1">
                  <div class="col-sm-8 mb-2">
                    <div className={`card mb-2 ${styles.rounded}`}>
                      <div
                        className={`card-body text-center ${tagPrimary} ${styles.rounded}`}
                      >
                  ...
                  {secondary ? (
                    <div class="col-sm-8 ">
                      <div className={`card ${styles.rounded}`}>
                        <div
                          className={`card-body text-center ${tagSecondary} ${styles.rounded}`}
                        >
                          <span style={{ color: "white" }}>
              ...
              {currentAccount == creator ? (
                    ...
                    <Card>
                      <Card.Header>
                        <CustomToggle eventKey="0">
                          Utenti che hanno acquistato il corso
                        </CustomToggle>
                      </Card.Header>
                ...
                <a
                  href={`https://goerli.etherscan.io/tx/${linkPurchase}`}
                  target="_blank"
                >
                  Dettagli acquisto✅
                </a>
